        ...
        <div class="max-w-4xl mx-auto">
            <div class="mb-8 flex justify-between items-end">
                <div>
                    ...
                    <p class="text-slate-400 font-medium">Update the details for <span class="text-blue-600">#{{ product.id }}</span></p>
                </div>
            </div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-12">
                        ...
                        <div class="space-y-4">
                            ...
                            <div class="relative group">
                                <div class="aspect-square rounded-[2rem] bg-slate-50 overflow-hidden border-2 border-dashed border-slate-200 flex items-center justify-center">
                            ...
                            <p v-if="form.errors.image" class="text-red-500 text-xs font-bold mt-1">{{ form.errors.image }}</p>
                        </div>

                        <div class="space-y-6">
                            <div>
                                <label class="block text-sm font-black text-slate-700 uppercase tracking-wider mb-2">Product Name</label>
                                ...
                                <p v-if="form.errors.name" class="text-red-500 text-xs font-bold mt-1">{{ form.errors.name }}</p>
                            </div>

                            <div class="grid grid-cols-2 gap-4">
                                <div>
                                    <label class="block text-sm font-black text-slate-700 uppercase tracking-wider mb-2">Price (₱)</label>
                                    <input type="number" step="0.01" v-model="form.price"
                                        class="w-full px-6 py-4 rounded-2xl bg-slate-50 border-transparent focus:bg-white focus:ring-4 focus:ring-blue-50 focus:border-blue-500 transition-all outline-none font-medium">
                                    <p v-if="form.errors.price" class="text-red-500 text-xs font-bold mt-1">{{ form.errors.price }}</p>
                                </div>
                                <div>
                                    <label class="block text-sm font-black text-slate-700 uppercase tracking-wider mb-2">Stock</label>
                                    <input type="number" v-model="form.stock"
                                        class="w-full px-6 py-4 rounded-2xl bg-slate-50 border-transparent focus:bg-white focus:ring-4 focus:ring-blue-50 focus:border-blue-500 transition-all outline-none font-medium">
                                    <p v-if="form.errors.stock" class="text-red-500 text-xs font-bold mt-1">{{ form.errors.stock }}</p>
                                </div>
                            </div>

                            <div>
                                <label class="block text-sm font-black text-slate-700 uppercase tracking-wider mb-2">Description</label>
                                ...
                                <p v-if="form.errors.description" class="text-red-500 text-xs font-bold mt-1">{{ form.errors.description }}</p>
                            </div>
                        </div>
                    </div>
